...
export class RegistrationRoutes {
    static get routes(): Router {
        ...
        /**
* @swagger
* ///events/{id}: Se debe cambiar esta linea para que funcione el endpoint de eliminar las inscripciones.
* /registrations/{eventId}/{userId}:
*   delete:
         ...
         *         description: Inscripción no encontrada
*/
        //router.delete(":eventId/:userId", asyncHandler(controller.eliminar)); Se debe agregar el / al inicio de la ruta para que funcione el endpoint.
